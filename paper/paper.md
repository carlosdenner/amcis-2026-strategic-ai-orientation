...
### 4.4 Threat Landscape: Sector-Specific Harm Fingerprints
...
**Coverage and robustness.** The heatmap (Figure 3) draws on the intersection of CSET sector labels and GMF technical failure labels (n=135 incidents, 10% of the full AIID corpus). Table 5 shows the AIID coverage cascade.
